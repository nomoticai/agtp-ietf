...
abbrev: "AGTP"
docname: draft-hood-independent-agtp-03
category: info
...
(AGIS) {{AGIS}}, which defines the grammar-based validation pathway for
...
deprecated; the canonical Agent-ID is permanently retired and **MUST NOT**
be retried. All AGTP-specific status codes are operational signals, not
protocol errors, and **MUST** be logged for audit purposes.
