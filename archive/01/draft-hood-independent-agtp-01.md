...
abbrev: "AGTP"
docname: draft-hood-independent-agtp-01
category: info
...
**MUST NOT** be retried. All three are operational signals, not protocol
...
agent registrations. See Section 8.5 for the full domain expiry policy.
...
: A cryptographically signed identity document issued to an agent at
  ...
  permanently bound, never reissued. See Section 5.7.
